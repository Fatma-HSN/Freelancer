	...
	<div class="container my-5">
		<div class="login-container">
			...
			<div class="text-center mt-3">
				<p>
					Pas encore de compte ? <br> <br> <a
						href="${cxt}/RegisterFreelancer" class="btn btn-warning">Inscrivez-vous
						Freelancer </a>
						 <a href="${cxt}/RegisterClient" class="btn btn-info">Inscrivez-vous
						Client </a>
